...
CREATE TABLE offices (
  ...
  addrebLine1 varchar(50) NOT NULL,
  addrebLine2 varchar(50),
...
insert  into offices(officeCode,city,phone,addrebLine1,addrebLine2,state_code,country,postalCode,territory) values 
...
(1002,'Murphy','Diane','x5800','dmurphy@clabicmodelcars.com','1',NULL,'President'),

(1056,'Patterson','Mary','x4611','mpatterso@clabicmodelcars.com','1',1002,'VP Sales'),

(1076,'Firrelli','Jeff','x9273','jfirrelli@clabicmodelcars.com','1',1002,'VP Marketing'),

(1088,'Patterson','William','x4871','wpatterson@clabicmodelcars.com','6',1056,'Sales Manager (APAC)'),

(1102,'Bondur','Gerard','x5408','gbondur@clabicmodelcars.com','4',1056,'Sale Manager (EMEA)'),

(1143,'Bow','Anthony','x5428','abow@clabicmodelcars.com','1',1056,'Sales Manager (NA)'),

(1165,'Jennings','Leslie','x3291','ljennings@clabicmodelcars.com','1',1143,'Sales Rep'),

(1166,'Thompson','Leslie','x4065','lthompson@clabicmodelcars.com','1',1143,'Sales Rep'),

(1188,'Firrelli','Julie','x2173','jfirrelli@clabicmodelcars.com','2',1143,'Sales Rep'),

(1216,'Patterson','Steve','x4334','spatterson@clabicmodelcars.com','2',1143,'Sales Rep'),

(1286,'Tseng','Foon Yue','x2248','ftseng@clabicmodelcars.com','3',1143,'Sales Rep'),

(1323,'Vanauf','George','x4102','gvanauf@clabicmodelcars.com','3',1143,'Sales Rep'),

(1337,'Bondur','Loui','x6493','lbondur@clabicmodelcars.com','4',1102,'Sales Rep'),

(1370,'Hernandez','Gerard','x2028','ghernande@clabicmodelcars.com','4',1102,'Sales Rep'),

(1401,'Castillo','Pamela','x2759','pcastillo@clabicmodelcars.com','4',1102,'Sales Rep'),

(1501,'Bott','Larry','x2311','lbott@clabicmodelcars.com','7',1102,'Sales Rep'),

(1504,'Jones','Barry','x102','bjones@clabicmodelcars.com','7',1102,'Sales Rep'),

(1611,'Fixter','Andy','x101','afixter@clabicmodelcars.com','6',1088,'Sales Rep'),

(1612,'Marsh','Peter','x102','pmarsh@clabicmodelcars.com','6',1088,'Sales Rep'),

(1619,'King','Tom','x103','tking@clabicmodelcars.com','6',1088,'Sales Rep'),

(1621,'Nishi','Mami','x101','mnishi@clabicmodelcars.com','5',1056,'Sales Rep'),

(1625,'Kato','Yoshimi','x102','ykato@clabicmodelcars.com','5',1621,'Sales Rep'),

(1702,'Gerard','Martin','x2312','mgerard@clabicmodelcars.com','4',1102,'Sales Rep');
...
CREATE TABLE customers (
  ...
  phone varchar(50) NOT NULL,
  addrebLine1 varchar(50) NOT NULL,
  addrebLine2 varchar(50) DEFAULT NULL,
  city varchar(50) NOT NULL,
  state_code varchar(50) DEFAULT NULL,
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addrebLine1,addrebLine2,city,state_code,postalCode,country,salesRepEmployeeNumber,creditLimit) values 
...
(144,'Volvo Model Replicas CO','Berglund','Christina ','0921-12 3555','Berguvsvagen  8',NULL,'LuleA',NULL,'S-958 22','Sweden',1504,'53100.00'),

(145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','Vinbaltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,'83400.00'),

(146,'Saveley  Henriot CO.','Saveley','Mary ','78.32.5555','2, rue du Commerce',NULL,'Lyon',NULL,'69004','France',1337,'123900.00'),

(148,'Dragon Souveniers, Ltd.','Natividad','Eric','+65 221 7555','Bronz Sok.','Bronz Apt. 36 Tesvikiye','Singapore',NULL,'079903','Singapore',1621,'103800.00'),

(151,'Muscle Machine Inc','Young','Jeff','2125557413','4092 Furth Circle','Suite 400','NYC','NY','10022','USA',1286,'138500.00'),

(157,'Diecast Clabics Inc.','Leong','Kelvin','2155551555','7586 Pompton St.',NULL,'Allentown','PA','70267','USA',1216,'100600.00'),
...
(169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da saude n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,'0.00'),

(171,'Daedalus Designs Imports','Rance','Martine ','20.16.1555','184, chaubee de Tournai',NULL,'Lille',NULL,'59000','France',1370,'82900.00'),
...
(189,'Clover Collections CO.','Cabidy','Dean','+353 1862 1555','25 Maiden Lane','Floor No. 4','Dublin',NULL,'2','Ireland',1504,'69400.00'),

(198,'Auto-Moto Clabics Inc.','Taylor','Leslie','6175558428','16780 Pompton St.',NULL,'Brickhaven','MA','58339','USA',1216,'23000.00'),
...
(216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de Cataluma, 23',NULL,'Barcelona',NULL,'08022','Spain',1702,'60300.00'),

(219,'Boards  Toys Co.','Young','Mary','3105552373','4097 Douglas Av.',NULL,'Glendale','CA','92561','USA',1166,'11000.00'),

(223,'Naturlich Autos','Klob','Horst ','0372-555188','Taucherstrabe 10',NULL,'Cunewalde',NULL,'01307','Germany',NULL,'0.00'),

(227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'Arhus',NULL,'8200','Denmark',1401,'120800.00'),

(233,'Quebec Home Shopping Network','Fresniere','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'Montreal','Quebec','H1J 1C3','Canada',1286,'48700.00'),

(237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran Via 1',NULL,'Madrid',NULL,'28001','Spain',NULL,'0.00'),
...
(247,'Mebner Shopping Network','Mebner','Renate ','069-0555984','Magazinweg 7',NULL,'Frankfurt',NULL,'60528','Germany',NULL,'0.00'),
...
(256,'Auto Abocies  Cie.','Tonini','Daniel ','30.59.8555','67 avenue de lEurope',NULL,'Versailles',NULL,'78000','France',1370,'77900.00'),

(259,'Toms Spezialitaten Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'Koln',NULL,'50739','Germany',1504,'120400.00'),

(260,'Royal Canadian Collectables Ltd.','Lincoln','Elizabeth ','(604) 555-4555','23 Tsawaben Blvd.',NULL,'Tsawaben','BC','T2F 8M4','Canada',1323,'89600.00'),

(273,'Franken Gifts CO','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'Munchen',NULL,'80805','Germany',NULL,'0.00'),
...
(298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'Geneve',NULL,'1203','Switzerland',1702,'141300.00'),
...
(319,'Mini Clabics','Frick','Steve','9145554562','3758 North Pendale Street',NULL,'White Plains','NY','24067','USA',1323,'102700.00'),
...
(328,'Tekni Collectables Inc.','Brown','William','2015559350','7476 Mob Rd.',NULL,'Newark','NJ','94019','USA',1323,'43000.00'),
...
(335,'Cramer Spezialitaten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL,'0.00'),

(339,'Clabic Gift Ideas, Inc','Cervantes','Francisca','2155554695','782 First Street',NULL,'Philadelphia','PA','71270','USA',1188,'81100.00'),
...
(361,'Kommibion Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'Munster',NULL,'44087','Germany',NULL,'0.00'),
...
(379,'Collectables For Leb Inc.','Nelson','Allen','6175558555','7825 Douglas Av.',NULL,'Brickhaven','MA','58339','USA',1188,'70700.00'),
...
(409,'Stuttgart Collectable Exchange','Muller','Rita ','0711-555361','Adenauerallee 900',NULL,'Stuttgart',NULL,'70563','Germany',NULL,'0.00'),
...
(424,'Clabic Legends Inc.','Hernandez','Maria','2125558493','5905 Pompton St.','Suite 750','NYC','NY','10022','USA',1286,'67500.00'),
...
(448,'Scandinavian Gift Ideas','Larbon','Martha','0695-34 6555','Akergatan 24',NULL,'Bracke',NULL,'S-844 67','Sweden',1504,'116400.00'),

(450,'The Sharp Gifts Warehouse','Frick','Sue','4085553659','3086 Ingle Ln.',NULL,'San Jose','CA','94217','USA',1165,'77600.00'),

(452,'Mini Auto Werke','Mendel','Roland ','7675-3555','Kirchgabe 6',NULL,'Graz',NULL,'8010','Austria',1401,'45300.00'),
...
(458,'Corrida Auto Replicas, Ltd','Sommer','Martin ','(91) 555 22 82','C Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,'104600.00'),
...
(473,'Frau da Collezione','Ricotti','Franco','+39 022515555','20093 Cologno Monzese','Alebandro Volta 16','Milan',NULL,NULL,'Italy',1401,'34800.00'),

(475,'West Coast Collectables Co.','Thompson','Steve','3105553722','3675 Furth Circle',NULL,'Burbank','CA','94019','USA',1166,'55400.00'),

(477,'Mit Vergnugen  Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL,'0.00'),

(480,'Kremlin Collectables CO.','Semenov','Alexander ','+7 812 293 0521','2 Pobedy Square',NULL,'Saint Petersburg',NULL,'196143','Rubia',NULL,'0.00'),
...
('Classic Cars','Attention car enthusiasts: Make your wildest car ownership dreams come true. Whether you are looking for clabic muscle cars, dream sports cars or movie-inspired miniatures, you will find great choices in this category. These replicas feature superb attention to detail and craftsmanship and offer features such as working steering system, opening forward compartment, opening rear trunk with removable spare wheel, 4-wheel independent spring suspension, and so on. The models range in size from 1:10 to 1:24 scale and include numerous limited edition and several out-of-production vehicles. All models include a certificate of authenticity from their manufacturers and come fully abembled and ready for display in the home or office.',NULL,NULL),

('Motorcycles','Our motorcycles are state of the art replicas of clabic as well as contemporary motorcycle legends such as Harley Davidson, Ducati and Vespa. Models contain stunning details such as official logos, rotating wheels, working kickstand, front suspension, gear-shift lever, footbrake lever, and drive chain. Materials used include diecast and plastic. The models range in size from 1:10 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. All models come fully abembled and ready for display in the home or office. Most include a certificate of authenticity.',NULL,NULL),

('Planes','Unique, diecast airplane and helicopter replicas suitable for collections, as well as home, office or clabroom decorations. Models contain stunning details such as official logos and insignias, rotating jet engines and propellers, retractable wheels, and so on. Most come fully abembled and with a certificate of authenticity from their manufacturers.',NULL,NULL),

('Ships','The perfect holiday or anniversary gift for executives, clients, friends, and family. These handcrafted model ships are unique, stunning works of art that will be treasured for generations! They come fully abembled and ready for display in the home or office. We guarantee the highest quality, and best value.',NULL,NULL),
...
('Vintage Cars','Our Vintage Car models realistically portray automobiles produced from the early 1900s through the 1940s. Materials used include Bakelite, diecast, plastic and wood. Most of the replicas are in the 1:18 and 1:24 scale sizes, which provide the optimum in detail and accuracy. Prices range from $30.00 up to $180.00 for some special limited edition replicas. All models include a certificate of authenticity from their manufacturers and come fully abembled and ready for display in the home or office.',NULL,NULL);
...
(10165,'2003-10-22','2003-10-31','2003-12-26','Shipped','This order was on hold because customerss credit limit had been exceeded. Order will ship when payment is received',148),
